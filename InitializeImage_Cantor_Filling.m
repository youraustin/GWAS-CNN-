function [ output_args ] = InitializeImage_Cantor_Filling( SizeLimitation, DataSetName)
...
DataSetName1 = strcat(char('Cantor_GA_'), DataSetName);

myroot1 = strcat('E:\final_results\filling\', num2str(Sizek), '\', DataSetName, '\', 'Cantor\', 'control');
if ~isdir(myroot1)
    mkdir(myroot1);
end

myroot2 = strcat('E:\final_results\filling\', num2str(Sizek), '\', DataSetName, '\', 'Cantor\', 'uncontrol');
if ~isdir(myroot2)
    mkdir(myroot2);
end
