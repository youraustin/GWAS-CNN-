function [ output_args ] = ImageRGBVaries_Spiral( DataSetName1, Sizek )
%IMAGERGBVARIES_SPIRAL Summary of this function goes here
...
myroot1 = strcat('E:\final_results\space_RGB\', num2str(Sizek), '\', DataSetName1, '\', 'Spiral\', 'control');
if ~isdir(myroot1) 
    mkdir(myroot1);
end

myroot2 = strcat('E:\final_results\space_RGB\', num2str(Sizek), '\', DataSetName1, '\', 'Spiral\', 'uncontrol');
if ~isdir(myroot2) 
    mkdir(myroot2);
end
