function [ output_args ] = InitializeImage_Cantor(DataSetName1, Sizek)
...
myroot1 = strcat('E:\final_results\space\', num2str(Sizek), '\', DataSetName1, '\', 'Cantor\', 'control');
if ~isdir(myroot1) 
    mkdir(myroot1);
end

myroot2 = strcat('E:\final_results\space\', num2str(Sizek), '\', DataSetName1, '\', 'Cantor\', 'uncontrol');
if ~isdir(myroot2) 
    mkdir(myroot2);
end
