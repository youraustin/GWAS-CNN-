function [ output_args ] = ImageRGBVaries_RowPrime( DataSetName1, Sizek )
%IMAGERGBVARIES_ROWPRIME Summary of this function goes here
...
myroot1 = strcat('E:\final_results\space_RGB\', num2str(Sizek), '\', DataSetName1, '\', 'RowPrime\', 'control');
if ~isdir(myroot1) 
    mkdir(myroot1);
end

myroot2 = strcat('E:\final_results\space_RGB\', num2str(Sizek), '\', DataSetName1, '\', 'RowPrime\', 'uncontrol');
if ~isdir(myroot2) 
    mkdir(myroot2);
end
