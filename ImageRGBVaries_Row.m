function [ output_args ] = ImageRGBVaries_Row( DataSetName1, Sizek )
%IMAGERGBVARIES_ROW Summary of this function goes here
...
myroot1 = strcat('E:\final_results\space_RGB\', num2str(Sizek), '\', DataSetName1, '\', 'Row\', 'control');
if ~isdir(myroot1) 
    mkdir(myroot1);
end

myroot2 = strcat('E:\final_results\space_RGB\', num2str(Sizek), '\', DataSetName1, '\', 'Row\', 'uncontrol');
if ~isdir(myroot2) 
    mkdir(myroot2);
end
